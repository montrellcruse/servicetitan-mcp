...
| `accounting_ap_credits_mark_as_exported` | write | Mark AP credits as exported |
| `accounting_ap_payments_list` | read | List AP payments |
| `accounting_ap_payments_mark_as_exported` | write | Mark AP payments as exported |
| `accounting_gl_account_types_list` | read | List GL account types |
| `accounting_gl_accounts_create` | write | Create a GL account |
| `accounting_gl_accounts_get` | read | Get a GL account by ID |
| `accounting_gl_accounts_list` | read | List GL accounts |
| `accounting_gl_accounts_update` | write | Patch a GL account |
| `accounting_invoice_items_delete` | delete | Delete an invoice item |
| `accounting_invoice_items_update` | write | Patch invoice items |
| `accounting_invoices_create_adjustment` | write | Create an adjustment invoice |
...
| `accounting_invoices_mark_as_exported` | write | Mark invoices as exported |
| `accounting_invoices_update` | write | Patch an invoice |
| `accounting_invoices_update_custom_fields` | write | Update invoice custom fields |
...
| `accounting_journal_entries_sync_update` | write | Trigger journal entry sync update |
| `accounting_journal_entries_update` | write | Patch a journal entry |
...
| `accounting_payments_update` | write | Patch a payment |
| `accounting_payments_update_custom_fields` | write | Update payment custom fields |
| `accounting_payments_update_status` | write | Update payment statuses |
| `accounting_tax_zones_list` | read | List tax zones |
## crm

| Tool | Operation | Description |
| --- | --- | --- |
| `crm_booking_provider_tags_create` | write | Create a booking provider tag |
...
| `crm_booking_provider_tags_update` | write | Patch a booking provider tag |
...
| `crm_bookings_provider_contacts_create` | write | Create a contact on a provider-scoped booking |
| `crm_bookings_provider_contacts_list` | read | List contacts for a provider-scoped booking |
| `crm_bookings_provider_contacts_update` | write | Patch a provider-scoped booking contact |
| `crm_bookings_provider_create` | write | Create a booking for a booking provider |
...
| `crm_bookings_provider_update` | write | Patch a provider-scoped booking |
| `crm_bulk_tags_add_tags` | write | Add bulk tags |
| `crm_bulk_tags_remove_tags` | delete | Remove bulk tags |
| `crm_contact_methods_create` | write | Create a contact method |
| `crm_contact_methods_delete` | delete | Delete a contact method |
| `crm_contact_methods_get` | read | Get a contact method |
| `crm_contact_methods_list` | read | List contact methods for a contact |
| `crm_contact_methods_update` | write | Patch a contact method |
| `crm_contact_methods_upsert` | write | Replace a contact method |
| `crm_contact_relationships_create` | write | Create a contact relationship |
| `crm_contact_relationships_delete` | delete | Delete a contact relationship |
...
| `crm_contacts_create` | write | Create a contact |
| `crm_contacts_delete` | delete | Delete a contact |
| `crm_contacts_get` | read | Get a contact by ID |
| `crm_contacts_list` | read | List contacts |
| `crm_contacts_replace` | write | Replace a contact |
| `crm_contacts_update` | write | Patch a contact |
| `crm_customers_contacts_create` | write | Create a customer contact |
| `crm_customers_contacts_delete` | delete | Delete a customer contact |
...
| `crm_customers_create` | write | Create a customer |
...
| `crm_customers_notes_create` | write | Create a note for a customer |
| `crm_customers_notes_delete` | delete | Delete a customer note |
| `crm_customers_notes_list` | read | List notes for a customer |
| `crm_customers_tags_create` | write | Create a tag assignment for a customer |
| `crm_customers_tags_delete` | delete | Delete a tag assignment from a customer |
| `crm_customers_update` | write | Patch a customer |
| `crm_leads_create` | write | Create a lead |
| `crm_leads_dismiss` | write | Dismiss a lead |
| `crm_leads_follow_ups_create` | write | Create a follow-up for a lead |
| `crm_leads_form_submit` | write | Submit a lead form |
| `crm_leads_get` | read | Get a lead by ID |
| `crm_leads_list` | read | List leads |
| `crm_leads_notes_create` | write | Create a note for a lead |
| `crm_leads_notes_list` | read | List notes for a lead |
| `crm_leads_update` | write | Patch a lead |
| `crm_location_labor_types_list` | read | List location labor types by locations |
| `crm_locations_contacts_create` | write | Create a contact for a location |
| `crm_locations_contacts_delete` | delete | Delete a location contact |
...
| `crm_locations_contacts_update` | write | Patch a location contact |
| `crm_locations_create` | write | Create a location |
...
| `crm_locations_notes_create` | write | Create a note for a location |
| `crm_locations_notes_delete` | delete | Delete a location note |
| `crm_locations_notes_list` | read | List notes for a location |
| `crm_locations_tags_create` | write | Create a tag assignment for a location |
| `crm_locations_tags_delete` | delete | Delete a tag assignment from a location |
| `crm_locations_update` | write | Patch a location |
## dispatch

| Tool | Operation | Description |
| --- | --- | --- |
| `dispatch_appointments_confirm` | write | Confirm an appointment |
| `dispatch_appointments_create` | write | Create an appointment |
| `dispatch_appointments_delete` | delete | Delete an appointment by ID |
| `dispatch_appointments_get` | read | Get an appointment by ID |
| `dispatch_appointments_hold` | write | Put an appointment on hold |
| `dispatch_appointments_list` | read | List appointments |
| `dispatch_appointments_reschedule` | write | Reschedule an appointment |
| `dispatch_appointments_set_summary` | write | Set an appointment summary. Private preview: only works for accounts with the ST feature enabled. |
| `dispatch_appointments_unconfirm` | delete | Remove appointment confirmation |
| `dispatch_appointments_unhold` | delete | Remove hold from an appointment |
| `dispatch_appointments_update_special_instructions` | write | Update appointment special instructions |
| `dispatch_arrival_window_configuration_get` | read | Get arrival window configuration |
| `dispatch_arrival_window_configuration_update` | write | Update arrival window configuration |
| `dispatch_arrival_windows_activate` | write | Activate an arrival window |
| `dispatch_arrival_windows_create` | write | Create a new arrival window |
| `dispatch_arrival_windows_get` | read | Get an arrival window by ID |
| `dispatch_arrival_windows_list` | read | List arrival windows |
| `dispatch_arrival_windows_update` | write | Update an arrival window |
...
| `dispatch_images_create` | write | Create an image placeholder |
| `dispatch_images_get` | read | Get image metadata by storage path |
| `dispatch_installed_equipment_attachments_create` | write | Upload an installed equipment attachment |
| `dispatch_installed_equipment_attachments_get` | read | Get installed equipment attachment metadata by storage path |
| `dispatch_installed_equipment_create` | write | Create installed equipment |
...
| `dispatch_installed_equipment_update` | write | Update installed equipment |
...
| `dispatch_job_types_create` | write | Create a job type |
| `dispatch_job_types_get` | read | Get a job type by ID |
| `dispatch_job_types_list` | read | List job types |
| `dispatch_job_types_update` | write | Update a job type. Warning: customFieldTypeIds uses ST replace semantics unless customFieldsUpdateMode is Merge. |
| `dispatch_jobs_booked_log_get` | read | Get booked log details for a job |
| `dispatch_jobs_cancel` | write | Cancel a job |
...
| `dispatch_jobs_create` | write | Create a job |
| `dispatch_jobs_create_attachment` | write | Attach a file to a job |
| `dispatch_jobs_custom_field_types_list` | read | List job custom field types |
| `dispatch_jobs_equipment_attach` | write | Attach installed equipment to a job |
| `dispatch_jobs_equipment_detach` | delete | Detach a single installed equipment item from a job. Requires confirm: true. |
| `dispatch_jobs_equipment_detach_bulk` | delete | Detach one or more installed equipment IDs from a job. Requires confirm: true. |
...
| `dispatch_jobs_notes_create` | write | Create a note for a job |
| `dispatch_jobs_notes_list` | read | List notes for a job |
| `dispatch_jobs_remove_cancellation` | write | Remove cancellation from a job |
| `dispatch_jobs_update` | write | Update a job |
...
| `dispatch_projects_attach_job` | write | Attach a job to a project |
| `dispatch_projects_create` | write | Create a project |
| `dispatch_projects_custom_field_types_list` | read | List project custom field types |
| `dispatch_projects_detach_job` | write | Detach a job from a project |
| `dispatch_projects_get` | read | Get a project by ID |
| `dispatch_projects_list` | read | List projects |
| `dispatch_projects_notes_create` | write | Create a note for a project |
| `dispatch_projects_notes_list` | read | List notes for a project |
| `dispatch_projects_update` | write | Update a project |
## estimates

| Tool | Operation | Description |
| --- | --- | --- |
| `estimates_create` | write | Create a new estimate |
| `estimates_dismiss` | write | Dismiss an estimate |
| `estimates_estimate_templates_create` | write | Create an estimate template |
| `estimates_estimate_templates_delete` | delete | Delete an estimate template by ID |
...
| `estimates_estimate_templates_update` | write | Update an estimate template. Warning: items are full-replace when provided; omit items to preserve existing template items. |
| `estimates_export_estimates` | read | Export estimates |
| `estimates_get` | read | Get a single estimate by ID |
| `estimates_items_delete` | delete | Delete a single item from an estimate |
| `estimates_items_list` | read | List estimate items with optional filters |
| `estimates_items_update` | write | Add a new SKU line or update an existing item on an estimate |
| `estimates_list` | read | List estimates with filters |
| `estimates_proposal_templates_create` | write | Create a proposal template |
| `estimates_proposal_templates_delete` | delete | Delete a proposal template by ID |
...
| `estimates_proposal_templates_update` | write | Update a proposal template. Warning: businessUnitIds and estimateAssignments are full-replace when provided; omit them to preserve existing assignments. |
| `estimates_proposal_types_list` | read | List proposal types |
| `estimates_sell` | write | Mark an estimate as sold |
| `estimates_unsell` | write | Revert an estimate from sold status |
| `estimates_update` | write | Update an existing estimate |
## export
...
| Tool | Operation | Description |
| --- | --- | --- |
| `inventory_purchase_order_markups_create` | write | Create a purchase order markup |
| `inventory_purchase_order_markups_delete` | delete | Delete a purchase order markup |
...
| `inventory_purchase_order_markups_update` | write | Update a purchase order markup |
| `inventory_purchase_order_types_create` | write | Create a purchase order type |
| `inventory_purchase_order_types_list` | read | List purchase order types |
| `inventory_purchase_order_types_update` | write | Update a purchase order type |
| `inventory_purchase_orders_approve_request` | write | Approve a purchase order request |
| `inventory_purchase_orders_cancel` | write | Cancel a purchase order |
| `inventory_purchase_orders_create` | write | Create a purchase order |
| `inventory_purchase_orders_get` | read | Get a purchase order by ID |
| `inventory_purchase_orders_list` | read | List purchase orders |
| `inventory_purchase_orders_reject_request` | write | Reject a purchase order request |
| `inventory_purchase_orders_requests_list` | read | List purchase order requests |
| `inventory_purchase_orders_update` | write | Update a purchase order |
| `inventory_receipts_cancel` | write | Cancel a receipt |
| `inventory_receipts_create` | write | Create a receipt |
| `inventory_receipts_list` | read | List receipts |
| `inventory_receipts_update_custom_fields` | write | Update receipt custom fields |
| `inventory_return_types_create` | write | Create a return type |
| `inventory_return_types_list` | read | List return types |
| `inventory_return_types_update` | write | Update a return type |
| `inventory_returns_cancel` | write | Cancel a return |
| `inventory_returns_create` | write | Create a return |
| `inventory_returns_list` | read | List returns |
| `inventory_returns_update` | write | Update a return |
| `inventory_returns_update_custom_fields` | write | Update return custom fields |
| `inventory_transfers_list` | read | List transfers |
| `inventory_transfers_update` | write | Update a transfer |
| `inventory_transfers_update_custom_fields` | write | Update transfer custom fields |
| `inventory_vendors_create` | write | Create a vendor |
| `inventory_vendors_get` | read | Get a vendor by ID |
| `inventory_vendors_list` | read | List vendors |
| `inventory_vendors_update` | write | Update a vendor |
| `inventory_warehouses_list` | read | List warehouses |
| `inventory_warehouses_update` | write | Update a warehouse |
## marketing
...
| `marketing_calls_update` | write | Update a call (v2) |
...
| `marketing_client_specific_pricing_update_rate_sheet` | write | Update a client-specific pricing rate sheet |
| `marketing_external_call_attributions_create` | write | Create external call attributions |
| `marketing_opt_in_outs_create` | write | Create opt-out records for phone numbers |
| `marketing_opt_in_outs_list` | read | List all opt-out records |
| `marketing_opt_in_outs_lookup_create` | write | Lookup opt-out records for phone numbers |
| `marketing_reviews` | read | List marketing reviews |
| `marketing_scheduled_job_attributions_create` | write | Create scheduled job attributions |
...
| `marketing_web_booking_attributions_create` | write | Create web booking attributions |
| `marketing_web_lead_form_attributions_create` | write | Create web lead form attributions |
## memberships

| Tool | Operation | Description |
| --- | --- | --- |
| `memberships_create` | write | Create a customer membership sale |
...
| `memberships_recurring_service_events_mark_complete` | write | Mark a recurring service event as complete |
| `memberships_recurring_service_events_mark_incomplete` | write | Mark a recurring service event as incomplete |
...
| `memberships_recurring_services_update` | write | Update a recurring service |
...
| `memberships_update` | write | Update a customer membership |
## payroll

| Tool | Operation | Description |
| --- | --- | --- |
| `payroll_employees_payrolls_list` | read | List payroll periods for an employee |
| `payroll_gross_pay_items_create` | write | Create a gross pay item |
| `payroll_gross_pay_items_delete` | delete | Delete a gross pay item |
| `payroll_gross_pay_items_list` | read | List gross pay items |
| `payroll_gross_pay_items_update` | write | Update a gross pay item |
| `payroll_payroll_adjustments_create` | write | Create a payroll adjustment |
...
| `payroll_payroll_settings_employee_update` | write | Update payroll settings for an employee |
...
| `payroll_payroll_settings_technician_update` | write | Update payroll settings for a technician |
...
| Tool | Operation | Description |
| --- | --- | --- |
| `people_employees_accountactions` | write | Run account actions for an employee |
| `people_employees_create` | write | Create an employee |
...
| `people_employees_update` | write | Update an employee |
| `people_gps_create` | write | Submit GPS pings from an external provider |
| `people_performance_get` | read | Get performance segmented by campaign/ad group/keyword |
| `people_technician_ratings_update` | write | Update technician rating for a specific job |
| `people_technician_shifts_bulk_delete` | write | Delete multiple technician shifts |
| `people_technician_shifts_create` | write | Create a technician shift |
| `people_technician_shifts_delete` | delete | Delete a technician shift |
| `people_technician_shifts_get` | read | Get a technician shift by ID |
| `people_technician_shifts_list` | read | List technician shifts |
| `people_technician_shifts_update` | write | Update a technician shift |
| `people_technicians_accountactions` | write | Run account actions for a technician |
| `people_technicians_create` | write | Create a technician |
| `people_technicians_get` | read | Get a technician by ID |
| `people_technicians_list` | read | List technicians |
| `people_technicians_update` | write | Update a technician |
| `people_trucks_list` | read | List trucks |
| `people_trucks_update` | write | Update a truck |
## pricebook

| Tool | Operation | Description |
| --- | --- | --- |
| `pricebook_bulk_create` | write | Create or import bulk pricebook operations |
| `pricebook_bulk_update` | write | Update pricebook records in bulk |
| `pricebook_categories_create` | write | Create a pricebook category |
| `pricebook_categories_delete` | delete | Delete a pricebook category |
| `pricebook_categories_get` | read | Get a pricebook category by ID |
| `pricebook_categories_list` | read | List pricebook categories |
| `pricebook_categories_update` | write | Update a pricebook category |
| `pricebook_discounts_fees_create` | write | Create a discount or fee |
| `pricebook_discounts_fees_delete` | delete | Delete a discount or fee |
| `pricebook_discounts_fees_get` | read | Get a discount or fee by ID |
| `pricebook_discounts_fees_list` | read | List discounts and fees |
| `pricebook_discounts_fees_update` | write | Update a discount or fee |
| `pricebook_equipment_delete` | delete | Delete equipment item |
| `pricebook_equipment_get` | read | Get equipment item by ID |
| `pricebook_equipment_list` | read | List equipment pricebook items |
| `pricebook_equipment_update` | write | Update equipment item |
| `pricebook_materials_cost_types_list` | read | List material cost types |
| `pricebook_materials_create` | write | Create a material pricebook item |
| `pricebook_materials_delete` | delete | Delete a material by ID |
| `pricebook_materials_get` | read | Get a material by ID |
| `pricebook_materials_list` | read | List material pricebook items |
| `pricebook_materials_markup_create` | write | Create a material markup range |
...
| `pricebook_materials_markup_update` | write | Update a material markup range |
| `pricebook_materials_update` | write | Update a material pricebook item |
| `pricebook_services_create` | write | Create a service pricebook item |
| `pricebook_services_delete` | delete | Delete a service pricebook item |
| `pricebook_services_get` | read | Get a service by ID |
| `pricebook_services_list` | read | List service pricebook items |
| `pricebook_services_update` | write | Update a service pricebook item |
## reporting
...
| Tool | Operation | Description |
| --- | --- | --- |
| `scheduling_appointment_assignments_assign_technicians` | write | Assign technicians to an appointment |
| `scheduling_appointment_assignments_list` | read | List appointment assignments |
| `scheduling_appointment_assignments_unassign_technicians` | write | Unassign technicians from appointments |
| `scheduling_business_hours_create` | write | Create business hour configuration |
| `scheduling_business_hours_list` | read | Get business hour configuration |
| `scheduling_capacity_calculate` | write | Calculate available time slots for scheduling. Returns arrival windows with technician availability for the given business unit(s) within the time window. Note: this is a POST that does not mutate state; it is flagged 'write' due to the HTTP verb. |
| `scheduling_non_job_appointments_create` | write | Create a non-job appointment |
| `scheduling_non_job_appointments_delete` | delete | Delete a non-job appointment |
...
| `scheduling_non_job_appointments_update` | write | Update a non-job appointment |
| `scheduling_teams_create` | write | Create a team |
| `scheduling_teams_delete` | delete | Delete a team |
...
| `settings_business_units_update` | write | Update a business unit |
| `settings_tag_types_create` | write | Create a tag type |
| `settings_tag_types_export` | read | Export tag types |
| `settings_tag_types_list` | read | List tag types |
| `settings_tag_types_update` | write | Update a tag type |
| `settings_tasks_create` | write | Create a task |
| `settings_tasks_create_subtask` | write | Create a subtask under an existing task |
